...
class SlopeCalActivity : AppCompatActivity() {
    ...
    private fun renderRecording(t: String) {
        ...
        note(when (stage) {
            ...
            "REC" -> "На время замера признаки пишутся часто, поэтому хватает " +
                "примерно 40-50 шагов. Два сигнала прозвучат сами, когда " +
                "наберётся достаточно. Телефон доставать не нужно."
